...
///
+ (void)configureWithAppId:(NSString * _Nonnull)appId trackedEventTypes:(NSArray * _Nullable)trackedEventTypes storageType:(enum VibesStorageEnum)storageType advertisingId:(NSString * _Nullable)advertisingId logger:(id <VibesLogger> _Nullable)logger apiUrl:(NSString * _Nullable)apiUrl;
/// Add a new Vibes delegate to the list of current delegates.
/// \param observer VibesAPIDelegate
///
- (void)addWithObserver:(id <VibesAPIDelegate> _Nonnull)observer;
